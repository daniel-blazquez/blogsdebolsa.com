...
Contains code from 'videodb':
Copyright (C) Andreas Goetz
...
class HTTPClient {
     ...
     */
    function HTTPClient(){
        $this->agent        = 'Mozilla/4.0 (compatible; lylina '.$version.'; '.PHP_OS.')';
        $this->timeout      = 15;
        $this->cookies      = array();
        $this->referer      = '';
        $this->max_redirect = 3;
...
// foreach is broken, temporary fix is to remove cookie support (not that important anyhow)
